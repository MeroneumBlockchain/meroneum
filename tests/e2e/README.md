...
# previous node state folder. By default this is './build/.meroneumd:/root/.meroneumd'
...
# By default this is 'meroneum_3369-1'
CHAIN_ID
```
...
the test suite exports `/.meroneumd` folder from the docker container
